                    ...
                    <div class="row row--50">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="product-large-thumbnail-2 single-product-thumbnail axil-product slick-layout-wrapper--15 axil-slick-arrow arrow-both-side-3">
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/furniture/product-1.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/furniture/product-2.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/furniture/product-3.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/furniture/product-4.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/furniture/product-5.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/furniture/product-6.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/furniture/product-7.png" alt="Product Images">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="small-thumb-wrapper product-small-thumb-2 small-thumb-style-two small-thumb-style-three">
                                        <div class="small-thumb-img ">
                                            <img src="/asset/images/product/furniture/product-1.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/furniture/product-2.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img active">
                                            <img src="/asset/images/product/furniture/product-3.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/furniture/product-4.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/furniture/product-5.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/furniture/product-6.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/furniture/product-7.png" alt="samll-thumb">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 mb--40">
                            <div class="single-product-content">
                                <div class="inner">
                                    <h2 class="product-title">Wooden Sofa Chair</h2>
                                    <div class="price-amount price-offer-amount">
                                        <span class="price current-price">$155.00</span>
                        ...
                        <div class="row mb--15">
                            <div class="col-lg-6 mb--30">
                                <div class="single-desc">
                                    ...
                                    <p>We’ve created a full-stack structure for our working workflow processes, were from the funny the century initial all the made, have spare to negatives. But the structure was from the funny the century rather, initial
