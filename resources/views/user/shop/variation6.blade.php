                    ...
                    <div class="row row--50">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="product-large-thumbnail-2 single-product-thumbnail axil-product slick-layout-wrapper--15 axil-slick-arrow arrow-both-side-3">
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/jewellery/product-1.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/jewellery/product-2.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/jewellery/product-3.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/jewellery/product-4.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/jewellery/product-5.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/jewellery/product-6.png" alt="Product Images">
                                        </div>
                                        <div class="thumbnail">
                                            <img src="/asset/images/product/jewellery/product-7.png" alt="Product Images">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="small-thumb-wrapper product-small-thumb-2 small-thumb-style-two small-thumb-style-three">
                                        <div class="small-thumb-img ">
                                            <img src="/asset/images/product/jewellery/product-1.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/jewellery/product-2.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img active">
                                            <img src="/asset/images/product/jewellery/product-3.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/jewellery/product-4.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/jewellery/product-5.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/jewellery/product-6.png" alt="samll-thumb">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="/asset/images/product/jewellery/product-7.png" alt="samll-thumb">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 mb--40">
                            <div class="single-product-content">
                                <div class="inner">
                                    <h2 class="product-title mb--40">Diamond Locket Chain</h2>
                                    <div class="price-amount">$155.00 - $160.00</div>
                                    ...
                                    <p class="description mb--40">In ornare lorem ut est dapibus, ut tincidunt nisi pretium. Integer ante est, hendrerit in rutrum quis, elementum eget magna. Pellentesque sagittis dictum libero, eu dignissim tellus.</p>
                                    <div class="product-features">
                                        <div class="table-responsive">
                                            <table>
                                                <tr>
                                                    <td><a href="single-product-5.html" class="mini-btn">See More</a></td>
                                                    <td>
                                                        <h6 class="title">Cashmere Tank</h6>
                                                    </td>
                                                    <td><span class="price-amount">$30</span></td>
                                                </tr>
                                                <tr>
                                                    <td><a href="single-product-2.html" class="mini-btn">See More</a></td>
                                                    <td>
                                                        <h6 class="title">Micro Form Bag</h6>
                                                    </td>
                                                    <td><span class="price-amount">$30</span></td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="product-action-wrapper d-flex-center">
                                        ...
                                        <ul class="product-action action-style-two d-flex-center mb--0">
                                            <li class="add-to-cart"><a href="https://www.amazon.com/" class="axil-btn btn-bg-primary">Buy on Amazon</a></li>
                                            ...
                                            <ul class="comment-list">
                                                    ...
                                                    <div class="comment-body">
                                                        <div class="single-comment">
                                                            <div class="comment-img">
                                                                <img src="/asset/images/blog/author-image-4.png" alt="Author Images">
                                                            </div>
                                                ...
                                                <li class="comment">
                                                    <div class="comment-body">
                                                        <div class="single-comment">
                                                            <div class="comment-img">
                                                                <img src="/asset/images/blog/author-image-5.png" alt="Author Images">
                                                            </div>
                                                            <div class="comment-inner">
                                                                <h6 class="commenter">
                                                                    <a class="hover-flip-item-wrapper" href="#">
